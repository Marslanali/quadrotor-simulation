...
#include <fstream>
#include <memory>
#include "../include/learn_quadrotor_trajectroy/datapoints.h"
#include "../include/learn_quadrotor_trajectroy/emInitilization.h"
#include "../include/learn_quadrotor_trajectroy/emInitilizationMlpack.h"
#include "../include/learn_quadrotor_trajectroy/matplotlibcpp.h"
#include "../include/learn_quadrotor_trajectroy/gmm.h"
#include "../include/learn_quadrotor_trajectroy/gmr.h"
...
// template function for str to double and int
template <typename  T>
T str_conversion(std::string const& s){
...
int main(int argc, char **argv)
{
    ...
    position_data->load_from_file("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/data/input_data/data_xy.txt");
...
*/
    ...
    std::ofstream file_kmean_mu("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/kmeans_mu.txt");
    std::ofstream file_kmean_sigma("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/kmeans_sigma.txt");
    std::ofstream file_gmm_mu("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/gmm_mu.txt");
    std::ofstream file_gmm_sigma("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/gmm_sigma.txt");
/*
...
*/
    ...
    std::ofstream file_kmean("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/data/kmeans/kmeans.txt");
    //file << 2 << " ";
    ...
    std::ofstream file_gmm("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/data/gmm/gmm.txt");
    //file << 2 << " ";
    //file << nb_states << std::endl;
    for(int i=0;i<nb_states;i++)
...
*/
    ...
    plt::save("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/input_clock.jpg");
    plt::show();
    ...
    plt::stem(x,y,".*");
    plt::save("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/centroids_gmm.jpg");
    plt::show();

    plt::plot(position_x,position_y,"red");
    plt::title("2-D Input data");
    plt::save("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/input_data_2D.jpg");
    plt::show();
    ...
    plt::save("/home/arslanali/quadrotor-simulation/learn_quadrotor_trajectroy/plots/input_data_1D.jpg");
    //plt::subplot(2,2,4);
